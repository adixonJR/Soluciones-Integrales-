...
const ComunidadActiva = () => {
  return (
    ...
    >
      ...
      <div>
         <section className="bg-[#111] text-white py--3 px--3 text-center">
    ...
    <div className="inner">
      <p className="text">Activa</p>
        ...
        <section className="bg-[#111] text-white py-16 px-4 text-center max-w-xl w-full">
...
<div className="text-sm text-gray-200 leading-relaxed transform translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-700 delay-100">
